...
company_names = %w(OIAX WJ GAIAX)

10.times do |n|
  10.times do |m|
    fn = family_names.sample.split(':')
    gn = given_names.sample.split(':')

    c = Customer.create!(
      email: "#{fn[2]}.#{gn[2]}.#{n}.#{m}@example.com",
      family_name: fn[0],
      given_name: gn[0],
