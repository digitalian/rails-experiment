class Staff::CustomerSearchForm
  ...
  attr_accessor :family_name_kana, :given_name_kana, :birth_year, :birth_month, :birth_mday, :address_type, :prefecture, :city, :postal_code, :phone_number, :gender, :last_four_digits
